            ...
            <?php while ($brands->have_posts()) : $brands->the_post(); ?>
                <article>
                    ...
                    <div class="social-button-large">
                        <ul>
                            <li>
                                <a class="socialite facebook-like" data-send="false" data-layout="box_count" data-width="60" data-show-faces="false" data-url="<?php the_permalink(); ?>">
                                    Share on Facebook
                                </a>
                            </li>
                            <li>
                                <a class="socialite twitter-share" data-url="<?php the_permalink(); ?>" data-count="vertical" data-text="<?php the_title(); ?>" data-via="acirdesign" 
                                   data-lang="it" data-related="mysweetycollage" data-hashtags="MySweety">
                                    Share on Twitter
                                </a>
                            </li>
                            <li>
