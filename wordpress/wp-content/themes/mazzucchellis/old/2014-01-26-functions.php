...
/**
 * Filtri e colonne per amministrare i prodotti anche in base alla slideshow.
 * @param type $columns
 * @return string
 */
//function my_columns($columns) {
//    $columns['prodotti_slideshow'] = 'Slideshow';
//    return $columns;
//}
//
//add_filter('manage_edit-prodotti_columns', 'my_columns');
//
//function populate_columns($column) {
//    if ('prodotti_slideshow' == $column) {
//        $slideshow = get_post_meta(get_the_ID(), 'slideshow_value', true);
//        echo $slideshow;
//    }
//}
//
...
//
//function sort_prodotti_columns($columns) {
//    $columns['prodotti_slideshow'] = 'prodotti_slideshow';
//    return $columns;
//}
//
//add_filter('manage_edit-prodotti_sortable_columns', 'sort_prodotti_columns');
